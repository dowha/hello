...
export default function ProjectDrawer({ project, categories }: DrawerProps) {
  ...
  return (
    ...
    >
      <Drawer.Trigger className="border border-[#e1e4e8] rounded-md p-2 bg-white hover:bg-[#f6f8fa] transition-colors duration-200 relative cursor-pointer w-full text-left overflow-hidden" onClick={(e) => e.currentTarget.blur()}>
