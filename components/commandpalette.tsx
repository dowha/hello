  ...
  return (
    <div className="flex justify-center items-center">
      <button
        ...
        className="mt-3 w-[260px] flex items-center gap-2 h-10 px-4 rounded-lg border border-gray-200 text-sm text-gray-500 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
      >
                ...
                <div className="py-2">
                  ...
                  {filteredItems.map((item) => (
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-900 hover:bg-gray-50 transition-colors duration-200"
                    >
                      {item.title}
                    </button>
                  ))}
